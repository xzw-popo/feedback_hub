...
```bash
ssh -p 36000 root@charvelxia-any2.devcloud.woa.com 'cd /opt/feedback_hub && ./.venv/bin/python -m feedback_hub.cli vectors rebuild --model qwen3-embedding-0.6b-document-v1 && scripts/vector_runtime.sh start'
```
